function s = quadr_doubleptr_patch2(s, Ns)
...
%s.type = 'periodic';
if ~isfield(s,'L'), s.L = 0; end % periodic shift
...
a = 0.3;
k = 3; % aspect ratio of (u,v) space
s = wobblytorus2(m,n,a,k);
Ns = [k,1]*50;
s = quadr_doubleptr_patch2(s, Ns);
showsurf(s)
...
for nn = 10:4:80
    Nu = k*nn; Nv = nn;
    s = quadr_doubleptr_patch2(s, [Nu,Nv]);
    flux = 0;
    for j = 1:ns
